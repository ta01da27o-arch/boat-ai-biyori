...
function updateHoleBets(ai){
  ...
  if(cols.length>=4){
    ...
    setCol(holeCol,[`${others[0]}-${others[1]}-${others[2]}`,`${others[0]}-${others[2]}-${others[1]}`,`${others[1]}-${others[0]}-${others[2]}`]);
  }
}
